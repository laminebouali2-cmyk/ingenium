...
export default function HomePage() {
  return (
    <>
      ...
      {/* ═══════════════════════════════════════════════════
          3. SOLUTION — asymétrique, mezzanine
      ═══════════════════════════════════════════════════ */}
      ...
      <section className="py-[clamp(5rem,10vw,10rem)] px-6 lg:px-10 bg-[rgba(10,14,18,0.02)]" aria-label="Réalisations Ingenium">
        <div className="mx-auto max-w-[1400px]">
          ...
          <RevealContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-4">

            {/* Projet 1 — villa piscine terrasse bois */}
            <RevealItem className="lg:col-span-2">
              <div className="group relative overflow-hidden border border-[rgba(10,14,18,0.08)] h-full">
                ...
                <div className="px-5 py-4 border-t border-[rgba(10,14,18,0.08)]">
            ...
            {/* Projet 2 — escalier bois LED portrait */}
            <RevealItem>
              <div className="group relative overflow-hidden border border-[rgba(10,14,18,0.08)] h-full">
                ...
                <div className="px-4 py-3.5 border-t border-[rgba(10,14,18,0.08)]">
            ...
            {/* Projet 4 — villa piscine deck gris */}
      ...
      {/* ═══════════════════════════════════════════════════
          4b. FILMSTRIP — défilement automatique
      ═══════════════════════════════════════════════════ */}
      <FilmStrip />
        ...
        <div className="mx-auto max-w-[1400px]">
          ...
          <div className="space-y-0 border-t border-[rgba(10,14,18,0.1)]">
            {[
              ...
              <Reveal key={step.n}>
                <div className={`grid lg:grid-cols-12 gap-8 lg:gap-16 items-center py-12 lg:py-16 border-b border-[rgba(10,14,18,0.08)] ${step.side === "left" ? "lg:[&>*:first-child]:order-last" : ""}`}>
